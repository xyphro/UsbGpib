...
#define _DESCRIPTORS_H_
	...
	/* Type Defines: */
		...
		enum StringDescriptors_t
		{
			...
			STRING_ID_Serial       = 3, /**< Serialstring ID */
		};
		...
		#define TMC_MAX_SERIAL_STRING_LENGTH (50)
		typedef struct
		{
			USB_Descriptor_Header_t Header;
			uint16_t                UnicodeString[TMC_MAX_SERIAL_STRING_LENGTH]; /* 80 bits for ATMega32U4 = 20 Characters*/
		} tmc_serial_t;
		
		extern tmc_serial_t tmc_serial_string;
